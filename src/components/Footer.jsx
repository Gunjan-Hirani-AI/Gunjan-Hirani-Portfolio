      ...
      <div className="container footer__inner">
        <div className="footer__left">
          <div className="footer__logo">
            <span className="footer__logo-icon">{initials}</span>
            <span className="footer__logo-text">{profile.name}</span>
          </div>
          <p className="footer__tagline">{profile.title} · {profile.tagline}</p>
          <p className="footer__copy">© {year} {profile.name}. All rights reserved.</p>
        </div>

        <div className="footer__center">
          <nav className="footer__nav">
            {['home','about','skills','experience','education','projects','contact'].map(s => (
              <a
                key={s}
                href={`#${s}`}
        ...
        <div className="footer__right">
          <div className="footer__socials">
            ...
            <a href={profile.aiPortfolio} target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="AI Portfolio">
