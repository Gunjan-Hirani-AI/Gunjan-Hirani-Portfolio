...
export default function Contact() {
  ...
  const contactLinks = [
    ...
    {
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
      ),
      label: 'AI Portfolio',
      value: 'ai-portfolio-dashboard.vercel.app',
  ...
  const externalLabels = new Set(['Phone / WhatsApp', 'GitHub', 'LinkedIn', 'AI Portfolio']);
        ...
        <div className="contact__inner">
          <div className="contact__left">
            ...
            <p className="contact__text">
              Whether you need an AI engineer for agents and RAG systems, a Node.js backend developer, or just want to connect — my inbox is always open.
            </p>
            ...
            <div className="contact__links">
              {contactLinks.map(link => (
                <a
                  key={link.label}
                  href={link.href}
                  target={externalLabels.has(link.label) ? '_blank' : undefined}
...
linkedin = "linkedin.com/in/gunjan-hirani"
github = "github.com/${profile.githubUsername}"
ai_portfolio = "ai-portfolio-dashboard.vercel.app"
